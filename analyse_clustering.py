...
def analyse_clustering(clustering_file_location,db_id,method='pval',feature_list=None,excluded_features=None,cluster_indices=None):
    ...
    >>> 
    >>> method = 'pval'
    >>> FR_df = analyse_clustering(clustering_file_location,db_id,method=method,feature_list=feature_list,excluded_features=None,cluster_indices=cluster_indices)
